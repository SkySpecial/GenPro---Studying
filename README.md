...
Текст в окружении вследствие неимения параметров размещается в текущей нулевой точке. При этом, если граф. объекты идут после текста, то правильное положение предпоследних сильно сбивается.
#Musescore
