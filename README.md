...
3) Где пресеты в рипере хранятся, папку не нашёл я!

4) Есть ли линейный уровень звука? А не логарифмический? Как быть тогда с ухом человека? Вопрос к относительному передвижению фейдеров на ПУТ, когда выделены, скажем, два трека.
